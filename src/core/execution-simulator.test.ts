...
import { FakeInventory, FakePolicy, SeqIds } from "./test-fakes.js";
...
test("netProfit matches the drifted proceeds-minus-cost (golden)", () => {
  ...
  // execBuy=100020 fee 10.002 ; execSell=100579.88 fee 10.057988
  // net = (10057.988 - 10.057988) - (10002 + 10.002) = 35.928012
...
test("updates wallets under the pre-positioned model (spend USDT on buy, gain USDT on sell)", () => {
  ...
  // bybit bought 0.1 BTC for quoteCost 10012.002
  ...
  // okx sold 0.1 BTC for quoteProceeds 10047.930012
